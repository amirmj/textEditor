...
public class EfficientDocument extends Document {
	...
	private void processText() {
		...
		numSentences = (tokens.size() - numWords == 0) ? 1 : numSentences;
	}
	...
	public static void main(String[] args) {
		...
		testCase(new EfficientDocument("This is a test.  How many???  " + "Senteeeeeeeeeences are here... there should be 5!  Right?"), 16,
				13, 5);
		...
		testCase(new EfficientDocument("Amir Masoud is developing software using java language."), 17, 8, 1);
	}
